...
export interface ApiBeerBeer extends Struct.CollectionTypeSchema {
	...
	attributes: {
		alcohol_percentage: Schema.Attribute.Decimal;
		beer_image: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
		Beer_name: Schema.Attribute.String;
		beer_type: Schema.Attribute.Enumeration<
			[
				'  Session Pale Ale',
				'  Witbier',
				'  Blondbier',
		...
		>;
		Beschikbaar: Schema.Attribute.Boolean;
		createdAt: Schema.Attribute.DateTime;
		createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
		description: Schema.Attribute.Blocks;
		EBC: Schema.Attribute.Integer;
		EBU: Schema.Attribute.BigInteger;
		ideal_temperature: Schema.Attribute.Decimal;
		locale: Schema.Attribute.String & Schema.Attribute.Private;
