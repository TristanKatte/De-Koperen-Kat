...
<section class="vacature-overview">
	...
	<p class="intro">
		Op het moment zitten we goed in het vaste personeel, maar hebben we altijd plek voor
		vrijwilligers die overdag willen meehelpen met hand-en-spandiensten.
	</p>
